...
material_function = [convert_to_openai_function(MaterialComposition)]
id_function = [convert_to_openai_function(Identification)]
materialmodel = llm.bind(functions=material_function, function_call={"name": "MaterialComposition"})
...
material_query = "Return material composition in document as list of chemicals and identification-related information from the document, including last date of revision"
