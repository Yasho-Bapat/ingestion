...
if __name__ == "__main__":
    ...
    processor = DocumentProcessor(documents_directory=directory_path, persist_directory="experiment_chroma_db", log_file="logs/ingestion_service_experiment.log", chunking_method="semantic", store_to_neo4j=True)
